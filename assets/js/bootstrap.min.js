...
!(function (t, e) {
  ...
  class nt extends q {
    ...
    show() {
      ...
      let t, e;
      this._parent &&
        ((t = i.find('.show, .collapsing', this._parent).filter((t) => ('string' == typeof this._config.parent ? t.getAttribute('data-bs-parent') === this._config.parent : t.classList.contains('collapse')))), 0 === t.length && (t = null));
