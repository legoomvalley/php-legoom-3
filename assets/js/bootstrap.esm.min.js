...
function bootstrapDelegationHandler(e, t, n) {
  return function i(s) {
    ...
    for (let { target: r } = s; r && r !== this; r = r.parentNode) for (let a = o.length; a--; ) if (o[a] === r) return (s.delegateTarget = r), i.oneOff && EventHandler.off(e, s.type, t, n), n.apply(r, [s]);
    return null;
  };
}
...
const EventHandler = {
    ...
    trigger(e, t, n) {
      ...
      let a,
        ...
        _ = null;
      return (
        o && i && ((a = i.Event(t, n)), i(e).trigger(a), (l = !a.isPropagationStopped()), (c = !a.isImmediatePropagationStopped()), (E = a.isDefaultPrevented())),
...
class Carousel extends BaseComponent {
  ...
  _getConfig(e) {
    return (e = { ...Default$9, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }), typeCheckConfig(NAME$a, e, DefaultType$9), e;
  }
  _handleSwipe() {
  ...
  _addEventListeners() {
    this._config.keyboard && EventHandler.on(this._element, EVENT_KEYDOWN, (e) => this._keydown(e)),
      'hover' === this._config.pause && (EventHandler.on(this._element, EVENT_MOUSEENTER, (e) => this.pause(e)), EventHandler.on(this._element, EVENT_MOUSELEAVE, (e) => this.cycle(e))),
  ...
  _addTouchEventListeners() {
    ...
    SelectorEngine.find(SELECTOR_ITEM_IMG, this._element).forEach((e) => {
      ...
      this._pointerEvent
        ? (EventHandler.on(this._element, EVENT_POINTERDOWN, (t) => e(t)), EventHandler.on(this._element, EVENT_POINTERUP, (e) => n(e)), this._element.classList.add('pointer-event'))
        : (EventHandler.on(this._element, EVENT_TOUCHSTART, (t) => e(t)), EventHandler.on(this._element, EVENT_TOUCHMOVE, (e) => t(e)), EventHandler.on(this._element, EVENT_TOUCHEND, (e) => n(e)));
  }
  _keydown(e) {
...
class Collapse extends BaseComponent {
  ...
  show() {
    ...
    let e, t;
    this._parent &&
      ((e = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter((e) => ('string' == typeof this._config.parent ? e.getAttribute('data-bs-parent') === this._config.parent : e.classList.contains('collapse')))),
      0 === e.length && (e = null));
...
class Dropdown extends BaseComponent {
  ...
  show() {
    ...
    if (!EventHandler.trigger(this._element, EVENT_SHOW$4, t).defaultPrevented) {
      ...
      'ontouchstart' in document.documentElement && !e.closest('.navbar-nav') && [].concat(...document.body.children).forEach((e) => EventHandler.on(e, 'mouseover', noop)),
        this._element.focus(),
...
class Modal extends BaseComponent {
  ...
  _getConfig(e) {
    return (e = { ...Default$5, ...Manipulator.getDataAttributes(this._element), ...('object' == typeof e ? e : {}) }), typeCheckConfig(NAME$6, e, DefaultType$5), e;
  }
  _showElement(e) {
    const t = this._isAnimated(),
...
class Tooltip extends BaseComponent {
  ...
  dispose() {
    clearTimeout(this._timeout), EventHandler.off(this._element.closest('.modal'), 'hide.bs.modal', this._hideModalHandler), this.tip && this.tip.remove(), this._popper && this._popper.destroy(), super.dispose();
  }
  show() {
    ...
    Data.set(i, this.constructor.DATA_KEY, this),
      this._element.ownerDocument.documentElement.contains(this.tip) || (a.appendChild(i), EventHandler.trigger(this._element, this.constructor.Event.INSERTED)),
  ...
  setElementContent(e, t) {
    if (null !== e)
      return isElement(t)
        ...
        : void (this._config.html ? (this._config.sanitize && (t = sanitizeHtml(t, this._config.allowList, this._config.sanitizeFn)), (e.innerHTML = t)) : (e.textContent = t));
  }
  getTitle() {
  ...
  _getConfig(e) {
    ...
    return (
      ...
      ((e = { ...this.constructor.Default, ...t, ...('object' == typeof e && e ? e : {}) }).container = !1 === e.container ? document.body : getElement(e.container)),
...
class Popover extends Tooltip {
  ...
  getTipElement() {
    return this.tip || ((this.tip = super.getTipElement()), this.getTitle() || SelectorEngine.findOne(SELECTOR_TITLE, this.tip).remove(), this._getContent() || SelectorEngine.findOne('.popover-body', this.tip).remove()), this.tip;
  }
  setContent() {
    const e = this.getTipElement();
